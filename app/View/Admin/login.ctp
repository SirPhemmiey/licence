...
<body style="font-family: 'Open Sans', sans-serif; text-align: center; font-weight: 200; background-color:#f5f5f5;">
  ...
  <br>
  <form class="form-signin form-horizontal" method="post" action="<?php echo $this->webroot;?>admin/login">
...
<center> <button class="btn btn-lg btn-primary btn-block" type="submit">
  ...
  <label class="checkbox pull-left">
    <input type="checkbox" value="remember-me" name="checkbox">
    Remember me
  </label>
   <a class="pull-right forgot-password" href="<?php echo $this->webroot;?>admin/forgotPassword">Forgot password?</a><span class="clearfix"></span>
</form>
</div>
</div><br><br><br>
