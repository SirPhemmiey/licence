...
<meta charset="utf-8">
<title>Super Admin - COSON Licensing Application Portal</title>
...
<a class="navbar-brand" href="<?php echo $this->webroot;?>"> <img alt="The logo" src="img/logo20.png" class="hidden-xs"/>
    <span>COSON Licensing Application Portal</span></a>
...
<ul class="dropdown-menu" role="menu"  aria-labelledby="dropdownMenu">
    <li role="presentation"><a class="link"  role="menuitem" href="<?php $this->webroot;?>superadmin/addAdmin">Add Admin</a></li>
    <li class="divider"></li>
    <li role="presentation"><a class="link" role="menuitem" href="<?php $this->webroot;?>superadmin/logout">Logout</a></li>
</ul>
</div>
    ...
    <div class="nav-canvas">
        ...
        <ul class="nav nav-pills nav-stacked main-menu">
           <!--  <li class="nav-header">Main</li> -->
            <li><a class="link" href="<?php $this->webroot;?>"><span> Main</span></a>
            </li>
