...
<div class="row">
<div class="col-md-10">
<form action="<?php echo $this->webroot;?>users/changePassword" method="POST">    
<div id="content" class="">
<!-- content starts -->
<?php $error = $this->Flash->render('passwordMatch');
$success = $this->Flash->render('successPassword');
$error_2 = $this->Flash->render('passwordBlank');
?>
<?php if(isset($error)){
 ...
 echo "<div class='alert alert-danger alert-dismissable'>";
    ...
    echo "</div>";
        ...
        <label for="password" class="control-label col-md-4">New Password   : </label>
            <div class="col-md-5">
               <input type="password" id="password-1" name="data[User][password]" class="form-control" placeholder="Enter your new password">
            </div>
        ...
        <label for="contact_person" class="control-label col-md-4">Confim Password   : </label>
            <div class="col-md-5">
               <input type="password" name="password-2" id="password-2" class="form-control" placeholder="Confirm your password">
            </div>
            <span class="help-block showError" style="color:red; display:none">Passwords do not match</span>
            <span class="help-block showEmpty" style="color:red; display:none">Passwords can not be blank</span>
        </div>
