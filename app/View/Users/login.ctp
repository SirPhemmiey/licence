...
<br>
                <form class="form-signin form-horizontal" method="post" action="<?php echo $this->webroot;?>users/login">
              ...
              echo "</div>";
               ...
               <center> <button class="btn btn-lg btn-primary btn-block" type="submit">
                    ...
                    <br>
                <a href="<?php echo $this->webroot;?>users/forgotPassword" class="pull-left need-help">Forgot Password? </a>
                <a href="<?php echo $this->webroot;?>#guidelines" class="pull-right need-help">Need help? </a><span class="clearfix"></span>
                </form>
            </div>
  </div><br><br><br>
