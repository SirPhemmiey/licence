...
<div class="row">
<label class="control-label col-md-5">Licence Id :</label> <div id="transId" class="col-md-7">
...
<div class="row">
<label class="control-label col-md-5">Company Name :</label> <div class="col-md-7" id="summaryName">

</div>
</div>
<div class="row">
<label class="control-label col-md-5">Contact Person :</label> <div class="col-md-7" id="summaryContact">

</div>
</div>
<div class="row">
<label class="col-md-5 control-label">Email Address :</label> <div class="col-md-7" id="summaryEmail">

</div> 
</div>
<div class="row">
<label class="col-md-5 control-label">Phone Number :</label> <div class="col-md-7" id="summaryPhone">

</div>
</div>
<div class="row">
<label class="col-md-5 control-label">Licence Category :</label> <div class="col-md-7 summaryCategory" id="summaryCategory">

</div>
<input type="hidden" name="data[Payment][licence_category]" value="" id="inputCategory" />
</div>
<div class="row">
<label class="col-md-5 control-label">Number of <span class="vehicle"> vehicle</span> (s) :</label> <div class="col-md-7 summaryVehiclesNumber" id="summaryVehiclesNumber">

</div>
<input type="hidden" name="data[Payment][number_of_vehicles]" value="" id="inputVehiclesNumber" />
</div>
<div class="row">
<label class="col-md-5 control-label">Number of <span class="userCat"> Category</span> (s) :</label> <div class="col-md-7 summaryUserCategoryNumber" id="summaryUserCategoryNumber">

</div>
<input type="hidden" name="data[Payment][number_of_centres]" value="" id="inputUserCategoryNumber" />
</div>
<div class="row">
<label class="col-md-5 control-label">Subcription Plan :</label> <div class="col-md-7 summaryPlan" id="summaryPlan">

</div>
<input type="hidden" name="data[Payment][subscription_plan]" value="" id="inputPlan" />
</div>
<div class="row">
<label class="col-md-5 control-label">Duration of Plan :</label> <div class="col-md-7 summaryDuration" id="summaryDuration">

</div>
<input type="hidden" name="data[Payment][duration]" value="" id="inputDuration" />
</div>
<div class="row">
<label class="col-md-5 control-label">Renewal Date : </label> <div class="col-md-7 summaryRenewal"></div>
<input type="hidden" name="data[Payment][renewal_date]" value="" id="inputRenewal" />
</div>
</div>
<div class="row">
<label class="col-md-5 control-label">Total Amount : </label> <div class="col-md-7 summaryTotal" id="summaryTotal">
</div>
