...
<link rel="stylesheet" href="<?php echo $this->webroot;?>css/dataTables.bootstrap.css"><script src="<?php echo $this->webroot;?>js/jquery-2.1.1.min.js"></script>
...
<!--         <script>
var renew = $('#renewal_date').text();
    var now = moment(new Date());
var end = moment(renew);
if(now > end){
     $('#headings').append('<th>Actions</th>');
  $('#data').append('<td><button class="btn btn-primary">Renew</button></td>');
}
else if(now <= end){
    alert("still intact");
}
...
<!-- <button type="button" id="renew" class="btn btn-default">Renew</button> -->
</footer>
...
<fieldset>
    ...
    <div class="form-group">
        ...
        <input type="text" disabled="disabled" class="f1-company-name form-control" id="company_name" name="data[User][company_name]" value="<?php if($this->Session->check('User.company_name')){ $name = $this->Session->read('User.company_name'); echo $name;}?>">
    </div>
    <div class="form-group">
        <label class="sr-only" for="f1-contact-person">Contact Person</label>
        <input type="text" disabled="disabled" class="f1-contact-person form-control" id="contact_person" name="data[User][contact_person]" value="<?php if($this->Session->check('User.contact_person')){ $contact_person = $this->Session->read('User.contact_person'); echo $contact_person;}?>">
    </div>

    <div class="form-group">
        <label class="sr-only" for="f1-email-address">Email address</label>
        <input type="email" disabled="disabled" class="f1-last-name form-control" id="email_address" name="data[User][email_address]" value="<?php if($this->Session->check('User.email_address')){ $email = $this->Session->read('User.email_address'); echo $email;}?>">
    </div>
    <div class="form-group">
        <label class="sr-only" for="f1-phone-number">Phone Number</label>
        <input type="number" disabled="disabled" class="f1-last-name form-control" id="phone_number" name="data[User][phone_number]" value="<?php if($this->Session->check('User.phone_number')){ $phone_number = $this->Session->read('User.phone_number'); echo $phone_number;}?>">
    </div>
