...
<div class="item" style="background-image: url(<?php echo $this->webroot;?>img/slider/new2.jpg);">
...
<div class="item" style="background-image: url(<?php echo $this->webroot;?>img/slider/grid2-music.jpg);">
<div class="slider-inner">
<div class="container">
<div class="row">
<div class="col-sm-6">
<div class="carousel-content">
<h2>Get Your Music License from <span>[CLAP]</span></h2>
...
<!--End Sign up modal-->
<!--Sign in modal-->
<div class="modal fade" id="signModal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
<div class="modal-dialog">
<div class="modal-content">
<div class="modal-header">
<button type="button" class="close" data-dismiss="modal" aria-hidden="true">
...
<h3 style="text-align:center;">Welcome! Please sign in</h3>
</div>
<div class="modal-body">
<div class="container">
<div class="row">
...
<a href="<?php echo $this->webroot;?>users/forgotPassword">Forgot Password? </a>
 </div>
<div class="col-xs-4 col-sm-6">
<a href="<?php echo $this->webroot;?>#guidelines">Need help? </a>            
</div>
</div>
